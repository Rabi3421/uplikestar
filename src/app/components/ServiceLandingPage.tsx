  ...
  return (
    <main className="relative overflow-x-hidden bg-background">
      ...
      <section className="px-6 md:px-12 py-24 md:py-28 bg-background">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-start">
          <div>
      ...
      <section className="px-6 md:px-12 py-24 md:py-28 bg-[#F0F2FF]">
      ...
      <section className="px-6 md:px-12 py-20 bg-gradient-hero">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[1fr_auto] gap-6 items-center">
          <div>
      ...
      <section className="px-6 md:px-12 py-24 md:py-28 bg-background border-t border-border">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-px bg-gradient-to-r from-primary to-accent" />
